...
## R-square of test for Boston
1 - sum((boslist_test$price-tree.pred.test)^2)/sum((boslist_test$price-mean(boslist_test$price))^2)
```
...
## R-square of test for Beijing
1 - sum((bjList_test$price-tree.pred.test)^2)/sum((bjList_test$price-mean(bjList_test$price))^2)
```
...
print(test_mse_rf)
## R-square of test for Boston
1 - sum((boslist_test$price-yhat_rf)^2)/sum((boslist_test$price-mean(boslist_test$price))^2)
...
## R-square of test for Beijing
1 - sum((bjList_test$price-yhat_rf)^2)/sum((bjList_test$price-mean(bjList_test$price))^2)
...
```{r}
Boston.boost=gbm(formula = price~., distribution = "gaussian", data = boslist_train, n.trees = 500,interaction.depth = 8, shrinkage = 0.005,cv.folds = 5)
...
rmse_fit^2
## R-square of test for Boston
1 - sum((boslist_test$price-boostpre)^2)/sum((boslist_test$price-mean(boslist_test$price))^2)
...
```{r}
beijing.boost=gbm(formula = price~., distribution = "gaussian", data = bjList_train, n.trees = 500,interaction.depth = 8, shrinkage = 0.005,cv.folds = 5)
...
rmse_fit^2
## R-square of test for Beijing
1 - sum((bjList_test$price-boostpre)^2)/sum((bjList_test$price-mean(bjList_test$price))^2)
```